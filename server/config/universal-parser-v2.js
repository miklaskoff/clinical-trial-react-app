...
const ALL_FIELDS = {
  ...
  conditions: ['CONDITION_TYPE', 'CONDITION_PATTERN', 'DISEASE_VARIANT', 'EXCEPTION_CONDITION'],
...
const CLUSTER_PRIMARY_FIELDS = {
  ...
  DIT: ['DISEASE_VARIANT', 'CONDITION_TYPE', 'NEGATION_DETECTED'],
  BIO: ['MEASUREMENTS', 'CONDITION_TYPE', 'CONDITION_PATTERN', 'LOGICAL_OPERATOR'],
  DD: ['CONDITION_TYPE', 'TIMEFRAME', 'LOGICAL_OPERATOR'],
...
5. v2.1 RULES (CRITICAL):
   ...
   - NEGATION_DETECTED is SUPPLEMENTARY - ALSO parse negated terms into normal fields (CONDITION_TYPE, DISEASE_VARIANT, etc.)
